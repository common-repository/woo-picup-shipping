...
final class ThirdPartyFulfillmentCollection implements JsonSerializable
{
     ...
     */
    public function setCollectionDate($collectionDate): void
    {
     ...
     * @return DateTime
     */
    public function getCollectionStartTime()
    {
     ...
     */
    public function setCollectionStartTime($collectionStartTime): void
    {
     ...
     * @return DateTime
     */
    public function getCollectionEndTime()
    {
     ...
     */
    public function setCollectionEndTime($collectionEndTime): void
    {
    ...
    public function jsonSerialize()
    {
        return [
            ...
            'collection_date' => $this->getCollectionDate(),
            'collection_start_time' => $this->getCollectionStartTime(),
            'collection_end_time' => $this->getCollectionEndTime(),
