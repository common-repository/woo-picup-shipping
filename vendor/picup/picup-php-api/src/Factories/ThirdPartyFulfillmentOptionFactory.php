...
final class ThirdPartyFulfillmentOptionFactory
{
    ...
    public static function make($decodedJsonObject): ThirdPartyFulfillmentOption
    {
        ...
        $option->setCollectedBefore(DateTime::createFromFormat('Y-m-d\TH:i:s', $decodedJsonObject->collected_before));
        $option->setDeliveredBefore(DateTime::createFromFormat('Y-m-d\TH:i:s', $decodedJsonObject->delivered_before));
