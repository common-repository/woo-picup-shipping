...
final class ThirdPartyFulfillmentBreakdownFactory
{
    ...
    public static function make($decodedJsonObject): FulfillmentBreakdown
    {
        ...
        $response->setCollectedBefore(DateTime::createFromFormat('Y-m-d*H:i:s', $decodedJsonObject->collected_before));
        $response->setDeliveredBefore(DateTime::createFromFormat('Y-m-d*H:i:s', $decodedJsonObject->delivered_before));
